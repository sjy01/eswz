    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-secondary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex mx-3 my-2" action="toNotice" method="post">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-end">
                    <c:if test="${requestScope.pageNo>1}">
                        <li class="page-item">
                            <a class="page-link text-black" href="toNotice?pageNo=1&pageSize=8&noticecontent=${requestScope.notice.noticecontent}">首页</a>
                        </li>
                    </c:if>
                    <c:if test="${requestScope.pageNo>1}">

                        <li class="page-item">
                            <a class="page-link text-black" href="toNotice?pageNo=${requestScope.pageNo-1}&pageSize=8&noticecontent=${requestScope.notice.noticecontent}">上一页</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${requestScope.pageNo<requestScope.pageCount}">
                        <li class="page-item">
                          <a class="page-link text-black" href="toNotice?pageNo=${requestScope.pageNo+1}&pageSize=8&noticecontent=${requestScope.notice.noticecontent}">下一页</a>
                        </li>
                    </c:if>
                    <c:if test="${requestScope.pageNo<requestScope.pageCount}">
                        <li class="page-item">
                     <a class="page-link text-black" href="toNotice?pageNo=${requestScope.pageCount}&pageSize=8&noticecontent=${requestScope.notice.noticecontent}">尾页</a>
                        </li>
                    </c:if>
                </ul>
            </nav>
