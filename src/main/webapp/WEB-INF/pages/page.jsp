...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="${pageContext.request.contextPath}/img/lunbo5.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="${pageContext.request.contextPath}/img/lunbo6.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="${pageContext.request.contextPath}/img/lunbo7.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<c:forEach items="${requestScope.goodsList}" var="goods">
  <div class="col-md-3">
      <div class="card my-3" style="width: 18rem;">
        <a href="detailGoods?goodsid=${goods.goodsid}"><img src="${pageContext.request.contextPath}/img/${goods.image}" class="card-img-top" alt="..." ></a>
        <div class="card-body">
        ...
        <div class="card-body text-center">
            <a href="insertCart?goodsid=${goods.goodsid}" class="link-secondary"><i class="fa fa-shopping-cart me-2"></i>加入购物车</a>
          <a href="detailGoods?goodsid=${goods.goodsid}" class="link-secondary"><i class="fa fa-hand-o-right me-2"></i>详情</a>
        </div>
      </div>
  </div>
</c:forEach>
...
<c:if test="${requestScope.pageNo>1}">
        <li class="page-item">
          <a class="page-link text-black" href="toadministrators?pageNo=1&pageSize=8&classification.classificationid=${requestScope.goods.classification.classificationid}&name=${requestScope.goods.name}">首页</a>
        </li>
</c:if>
<c:if test="${requestScope.pageNo>1}">

        <li class="page-item">
          <a class="page-link text-black" href="toadministrators?pageNo=${requestScope.pageNo-1}&pageSize=8&classification.classificationid=${requestScope.goods.classification.classificationid}&name=${requestScope.goods.name}">上一页</a>
        </li>
</c:if>
        ...
        <li class="page-item">
          <a class="page-link text-black" href="toadministrators?pageNo=${requestScope.pageNo+1}&pageSize=8&classification.classificationid=${requestScope.goods.classification.classificationid}&name=${requestScope.goods.name}">下一页</a>
        </li>
</c:if>
        <c:if test="${requestScope.pageNo<requestScope.pageCount}">
        <li class="page-item">
          <a class="page-link text-black" href="toadministrators?pageNo=${requestScope.pageCount}&pageSize=8&classification.classificationid=${requestScope.goods.classification.classificationid}&name=${requestScope.goods.name}">尾页</a>
        </li>
        </c:if>
      </ul>
    </nav>
...
<div class="bg-dark">
  <div class="row p-3">
    <div class="iconColor text-center">
      <a href="a"><i class="fa fa-weixin me-2"></i></a> <a href="#"></a> <a href="#"><i class="fa fa-qq me-2"></i></a> <a href="#"></a>  <a href="#"><i class="fa fa-google-plus me-2"></i></a> <a href="#"></a> <a href="#"><i class="fa fa-github me-2"></i></a> <a href="#"></a> <a href="#"><i class="fa fa-twitter"></i></a>
    </div>
  </div>
</div>
