    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${requestScope.informationList}" var="information">
            <tr>
                ...
                <c:if test="${information.state}">
                    <td>在线</td>
                </c:if>
                <td><a href="toupdateInformation?id=${information.id}" class="link-secondary">修改</a></td>
                <td><a href="deleteInformation?id=${information.id}" class="link-secondary">删除</a></td>
            </tr>
        </c:forEach>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-end">
            <c:if test="${requestScope.pageNo>1}">
                <li class="page-item">
                    <a class="page-link text-black" href="toMyInformation?pageNo=1&pageSize=8&content=${requestScope.Information.content}">首页</a>
                </li>
            </c:if>
            <c:if test="${requestScope.pageNo>1}">

                <li class="page-item">
                    <a class="page-link text-black" href="toMyInformation?pageNo=${requestScope.pageNo-1}&pageSize=8&content=${requestScope.Information.content}">上一页</a>
                </li>
            </c:if>
            ...
            <c:if test="${requestScope.pageNo<requestScope.pageCount}">
                <li class="page-item">
                    <a class="page-link text-black" href="toMyInformation?pageNo=${requestScope.pageNo+1}&pageSize=8&content=${requestScope.Information.content}">下一页</a>
                </li>
            </c:if>
            <c:if test="${requestScope.pageNo<requestScope.pageCount}">
                <li class="page-item">
                    <a class="page-link text-black" href="toMyInformation?pageNo=${requestScope.pageCount}&pageSize=8&content=${requestScope.Information.content}">尾页</a>
                </li>
            </c:if>
        </ul>
    </nav>
