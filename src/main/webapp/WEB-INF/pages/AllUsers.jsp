  ...
  <table class="table table-striped">
    ...
    <c:forEach items="${requestScope.allUsers}" var="User">
      ...
      <tr>
        ...
        <td><img src="${pageContext.request.contextPath}/img/${User.img}" alt="" style="width: 50px;height: 50px"></td>
        <td>${User.username}</td>
        ...
        <c:if test="${User.state==true}">
          <td><a href="updateUserState?userid=${User.userid}&state=${User.state}">封禁</a> </td>
        </c:if>
        <c:if test="${User.state==false}">
          <td><a href="updateUserState?userid=${User.userid}&state=${User.state}">解封</a> </td>
        </c:if>
