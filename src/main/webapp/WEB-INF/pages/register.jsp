...
<div class="ccontainer-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-3 my-4" >
            ...
            <form id="regForm" method="post" action="userRegister" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3 my-3"> <span class="input-group-text" id="basic-addon4">&nbsp&nbsp密&nbsp&nbsp&nbsp&nbsp码&nbsp</span>
                    ...
                    <i class="fa fa-eye mb-3 my-3 mx-3 fa-2x" id="eye1" style="background-color: #fff"></i>
                </div>
                <div class="input-group mb-3 my-3"> <span class="input-group-text" id="basic-addon5">&nbsp确认密码</span>
                    ...
                    <i class="fa fa-eye mb-3 my-3 mx-3 fa-2x" id="eye2" style="background-color: #fff"></i>
                </div>
...
<%--                </div>--%>
                ...
                <div class="row py-3">
                    ...
                    <div class="col-md-4">
                        <a href="toUsersLogin" class="link-dark mx-3  text-decoration-none">去登录</a>
                    </div>
                </div>
            </form>
